...
public class RoomUI {
	...
	public static void main(String[] args) {
		...
		RoomManagement roomMan; // RoomManagement 클래스를 roomMan을 선언한다
		...
		try { // 파일 try-catch
			...
			roomMan = new RoomManagement(inputFile3, inputFile2, inputFile); //RoomManagement클래스 생성자를 roomMan으로 선언
